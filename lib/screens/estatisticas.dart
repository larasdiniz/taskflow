...
class _EstatisticasPageState extends State<EstatisticasPage> {
    ...
    return Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Colors.grey.withOpacity(
                            themeModel.isDarkMode ? 0.1 : 0.15),
                        blurRadius: 5,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _barraGrafico(
                              concluidas, "Concluídas", 0.7, const Color(0xFF44DE7C)),
                          _barraGrafico(
                              pendentes, "Pendentes", 0.2, const Color(0xFF818181)),
                          _barraGrafico(
                              total, "Total", 1.0,
                ...
                const SizedBox(height: 30), // espaço extra p/ scroll
              ],
            ),
          ),
        ),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            _navIcon("assets/icons/icon_tarefas_cinza.png",
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const TarefasPage())),
                themeModel),
            _navIcon("assets/icons/icon_categorias_cinza.png",
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const CategoriasPage())),
                themeModel),
            _navIcon("assets/icons/icon_metas_cinza.png",
                () => Navigator.push(context,
            ...
            _navIcon("assets/icons/icon_config_cinza.png",
                () => Navigator.push(context,
  ...
  Widget _navIcon(String asset, VoidCallback onTap, ThemeModel themeModel) {
